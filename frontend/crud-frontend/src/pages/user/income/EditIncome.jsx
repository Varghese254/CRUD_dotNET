// pages/user/income/EditIncome.jsx
        ...
        <div style={styles.mainContent}>
          ...
          <main style={styles.main}>
            <div style={styles.loadingContainer}>
              ...
              <p style={styles.loadingText}>Loading income data...</p>
            </div>
          </main>
        </div>
        <UserFooter />
        ...
        <main style={styles.main}>
          <div style={styles.contentWrapper}>
            ...
            <div style={styles.pageHeader}>
              ...
              <div>
                <h1 style={styles.pageTitle}>Edit Income</h1>
                <p style={styles.pageSubtitle}>Update your income details</p>
              </div>
            </div>
            ...
            <div style={styles.tipsCard}>
              ...
              <ul style={styles.tipsList}>
                ...
                <li style={styles.tipItem}>You can change the category if this income source has changed</li>
                <li style={styles.tipItem}>Update the date if you want to move this income to a different month</li>
            ...
            <div style={styles.deleteSection}>
              ...
              <p style={styles.deleteText}>
                Once you delete an income entry, it cannot be recovered.
              </p>
              <button
                onClick={async () => {
